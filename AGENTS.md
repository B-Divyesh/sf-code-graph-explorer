# Browser-based interactive call/dependency graph explorer for local codebases (Sourcetrail successor) (`code-graph-explorer`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://code-graph-explorer.sociobot.in`. Artifact class: `static-web`.
