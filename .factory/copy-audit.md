...
| It skips named dependency and build folders. | 7 |
| Drop a folder here | 4 |
| Press Enter to choose a folder. | 6 |
| Import a Graphite index | 4 |
| Follow one function at a time | 6 |
| Select a function to see callers, callees, imports, and its source location together. | 13 |
| How Graphite maps a codebase | 6 |
| Open a folder. | 3 |
| Choose supported source files from your device. | 7 |
| Select a function. | 3 |
| Move through linked calls, imports, and source. | 7 |
| Export the index. | 3 |
...
| Concept | Term |
| --- | --- |
| Files being inspected | codebase |
